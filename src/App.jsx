...
function App() {
  ...
  return (
    <>
                      ...
                      <div className={`service-card-inner ${flippedCards[service.id] ? 'flipped' : ''}`}>
                        ...
                        <div className="service-card-back">
                          ...
                          <button 
                            ...
                            style={selectedAnalysis.includes(service.title) ? { backgroundColor: 'white', color: '#111' } : {}}
                          >
      ...
      <section className="booking-section animate-on-scroll" id="agendar" style={{ padding: '6rem 0', backgroundColor: '#0a0a0a' }}>
        <div className="container">
          <div className="section-header" style={{ marginBottom: '4rem' }}>
            <h2 className="section-title" style={{ fontSize: '2.5rem' }}>AGENDAR DIAGNÓSTICO</h2>
            <div className="section-title-line"></div>
          </div>
      ...
      <section className="cta animate-on-scroll" id="contacto">
        <div className="container cta-content">
          ...
          <p className="cta-desc">
            "Cuéntanos tu caso y te orientamos"<br/>
            Envíanos un mensaje o completa nuestro formulario de diagnóstico para comenzar.
          </p>
          <div className="contact-buttons">
            <button className="btn-pill-solid-pink" onClick={() => window.open('https://wa.me/56982827603', '_blank')}>
              <svg viewBox="0 0 24 24" fill="currentColor" style={{ width: '20px', height: '20px', marginRight: '10px' }}>
            ...
            <a href="mailto:amunarq@gmail.com" className="btn-pill-outline" style={{ textDecoration: 'none' }}>
              <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" style={{ width: '20px', height: '20px', marginRight: '10px' }}>
      ...
      <footer className="footer relative">
        <div className="container">
          <div className="footer-logo">Amun</div>
          ...
          <p className="footer-bottom">
            © {new Date().getFullYear()} AMUN ARQUITECTURA. TIERRA Y ADOBE.
          </p>
        </div>
      </footer>
